...
RUN curl -L -o factorio-headless.tar.xz "https://factorio.com/get-download/${FACTORIO_VERSION}/headless/linux64"
...
RUN curl -o Krastorio2_1.3.8.zip "https://factorio-launcher-mods.storage.googleapis.com/Krastorio2/1.3.8.zip"
RUN curl -o flib_0.11.2.zip "https://factorio-launcher-mods.storage.googleapis.com/flib/0.11.2.zip"
RUN curl -o Krastorio2Assets_1.2.1.zip "https://factorio-launcher-mods.storage.googleapis.com/Krastorio2Assets/1.2.1.zip"
